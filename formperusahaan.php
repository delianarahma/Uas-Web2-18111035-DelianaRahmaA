                     ...
                     <h2>Pra Magang!</h2>
                       ...
                       <div class="card">
                        <div class="card-body bg-light">
                          <h5> Yuk, Isi Form Info Perusahaan!</h5>
                          <p>Silahkan isi data dibawah ini dengan benar!</p>
                          </div>
                        <form action="config/tambah_user.php" action="#" method="POST">
                            <div class="form-group">
                              <label for="nama">Nama perusahaan</label>
                              <input type="name" id="nama" nama_perusahaan="nama" class="form-control" placeholder="Silahkan Masukan Nama" maxlength="20" min="3">
                            </div>

                            <div class="form-group">
                              <label for="npm">Alamat</label>
                              <input type="name" id="npm" alamat="npm" class="form-control" placeholder="Silahkan Masukan Npm" maxlength="10" min="8">
                            </div>

                            <div class="form-group">
                              <label for="kelas">Kode pos</label>
                              <input type="input" id="kelas" kode_pos="kelas" class="form-control" placeholder="Silahkan Masukkan Kelas" > 
                            </div>

                            <div class="form-group">
                              <label for="email">Jam buka</label>
                              <input type="email" id="email" jam_buka="email" class="form-control" placeholder="Silahkan Masukkan Email" > 
                            </div>

                            <div class="form-group">
                                <label for="username">Provinsi</label>
                                <input type="input" id="username" name="username" class="form-control" placeholder="Silahkan Masukkan Username" maxlength="20" minlength="3">
                            </div>


                            <div class="form-group">
                                <label for="inputPassword">Telepon</label>
                              <input type="password" id="pass" name="password" class="form-control" placeholder="Silahkan Masukkan Password" maxlength="15" minlength="6">
                            </div>

                            <div class="form-group">
                                <label for="inputPassword">Divisi</label>
                              <input type="password" id="pass" name="password" class="form-control" placeholder="Silahkan Masukkan Password" maxlength="15" minlength="6">
                            </div>

                            <div class="form-group">
                                <label for="inputPassword">Need_person</label>
                              <input type="password" id="pass" name="password" class="form-control" placeholder="Silahkan Masukkan Password" maxlength="15" minlength="6">
                            </div>
